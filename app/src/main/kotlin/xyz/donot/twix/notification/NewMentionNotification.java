package xyz.donot.twix.notification;
...
import xyz.donot.twix.view.activity.MainActivity;
...
public class NewMentionNotification {
  ...
  public static void notify(final Context context,
    ...
    final NotificationCompat.Builder builder = new NotificationCompat.Builder(context)
      ...
      .setTicker(txtString)
      .setNumber(number)
      .setContentIntent(PendingIntent.getActivity(context, 0, null, PendingIntent.FLAG_UPDATE_CURRENT))
