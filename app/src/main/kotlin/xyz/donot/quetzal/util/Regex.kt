...
object Regex {
     ...
     * This pattern is auto-generated by //device/tools/make-iana-tld-pattern.py
     */
    val WEB_URL_PATTERN = Pattern.compile(
    ...
    var DOMAIN_NAME_PATTERN = Pattern.compile(
     ...
     *
     */
    val PHONE_PATTERN = Pattern.compile(// sdd = space, dot, or dash
            "(\\+[0-9]+[\\- \\.]*)?"                    // +<digits><sdd>*
    ...
    val HASHTAG_PATTERN = Pattern.compile("(#|\uFF03)($HASHTAG_ALPHA_NUMERIC*$HASHTAG_ALPHA$HASHTAG_ALPHA_NUMERIC*)", Pattern.CASE_INSENSITIVE)
    val VALID_HASHTAG_GROUP_BEFORE = 1
    val VALID_HASHTAG_GROUP_HASH = 2
    val VALID_HASHTAG_GROUP_TAG = 3
    val INVALID_HASHTAG_MATCH_END = Pattern.compile("^(?:[#＃]|://)")
    val RTL_CHARACTERS = Pattern.compile("[\u0600-\u06FF\u0750-\u077F\u0590-\u05FF\uFE70-\uFEFF]")

    val AT_SIGNS = Pattern.compile("[$AT_SIGNS_CHARS]")
    val MENTION_PATTERN = Pattern.compile("($AT_SIGNS+)([a-z0-9_]{1,20})(/[a-z][a-z0-9_\\-]{0,24})?", Pattern.CASE_INSENSITIVE)
    ...
    val VALID_REPLY = Pattern.compile("^(?:$UNICODE_SPACES)*$AT_SIGNS([a-z0-9_]{1,20})", Pattern.CASE_INSENSITIVE)
    val VALID_REPLY_GROUP_USERNAME = 1

    val INVALID_MENTION_MATCH_END = Pattern.compile("^(?:[$AT_SIGNS_CHARS$LATIN_ACCENTS_CHARS]|://)")

    val VALID_URL = Pattern.compile(VALID_URL_PATTERN_STRING, Pattern.CASE_INSENSITIVE)
    ...
    val VALID_TCO_URL = Pattern.compile("^https?://tInstance\\.co/[a-z0-9]+", Pattern.CASE_INSENSITIVE)
